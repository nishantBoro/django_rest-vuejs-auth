"""
Please make changes below wherever required. I have marked mandatory settings as "**Don't forget to..."
You should rename this file as settings.py afterwards
...
# **Dont forget to add your secret key below
...
# added corsheaders app and simplejwt token blacklist feature
INSTALLED_APPS = [
